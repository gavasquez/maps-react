...
export const MapProvider = ({ children }: Props) => {
    ...
    useEffect(() => {
        ...
        for (const place of places) {
            ...
            const newMaker = new Marker().setPopup(popup).setLngLat([lng, lat]).addTo(state.map!);
    ...
    //
    const getRouterBetwenPoints = async (start: [number, number], end: [number, number]) => {
        ...
        //* Estilos de la polyline para que se vea
        state.map?.addLayer({
            id: 'RouteString',
            type: 'line',
            source: 'RouteString',
